    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="field span4">
                <div class="valign-text"><p><a href="<?php echo $this->createurl('/catalog/details', array('model_id'=>$autoModel->id, 'engine_id'=>$data->id, 'brand'=>$this->brand['alias'])); ?>" class="b-button b-button-blue">Выбрать</a></p></div>
            </div>
        </div>
    </div>
</div>