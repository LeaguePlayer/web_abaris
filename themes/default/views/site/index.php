        ...
        <div class="span6 column1">
            ...
            <div class="row num-block">
                ...
                <div class="span5"><p>Не знаете артикул? Можете продолжить поиск по каталогу:</p>
                    <div class="row">
                        <div class="span5"><a href="<?php echo $this->createUrl('/catalog/index', array('brand'=>$this->brand['alias'])); ?>" class="b-button b-button-blue">Каталог  Абарис</a></div>
                    </div>
                    <div class="row">
                        <div class="span5">
                            <div class="or-line">
            ...
            <div class="row num-block">
                ...
                <div class="span5"><p>Хорошо разбираетесь в устройстве автомобиля? У нас для Вас есть официальный каталог EPC:</p>
                    <div class="row">
                        <div class="span5"><a href="<?php echo $this->createUrl('/eps/index', array('brand'=>$this->brand['alias'])); ?>" class="b-button b-button-blue">Каталог  EPC</a></div>
                    </div>
                </div>
            </div>
        </div>
