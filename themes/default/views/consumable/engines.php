...
<div class="engine-model">
    <div class="container">
        <div class="row">
            <div class="span4 img"><?php if ( $autoModel->hasImage() ) echo $autoModel->getImage('big'); ?></div>
            <div class="span4">
...
<div class="catalog-container">
    <div class="catalog-grid">
        ...
        <div class="catalog-grid-row select">
            <div class="container">
                <div class="row-fluid">
                    <div class="field span8">
                        <div class="valign-text"></div>
...
<div class="engine-info">
    <div class="container">
        <div class="row">
            <div class="span12">
                Затрудняетесь выбрать или не знаете где посмотреть эти данные позвоните нам: <span>+7 <span class="red">(3452)</span> <?=Settings::getOption('phone')?></span>
            </div>
        </div>
        <div class="row">
