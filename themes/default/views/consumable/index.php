...
$this->breadcrumbs = array(
    'Каталог расходных материалов ' . $this->brand['name']
);
?>
                        ...
                        <div class="row">
                            <div class="span2 img">
                                <div class="valign-text">
                                    <p><a href="<?php echo $this->createUrl('/consumable/engines', array('model_id'=>$item['id'], 'brand'=>$this->brand['alias'])); ?>">
                            ...
                            <div class="span2">
                                <div class="valign-text">
                                    <p>
                                        <a href="<?php echo $this->createUrl('/consumable/engines', array('model_id'=>$item['id'], 'brand'=>$this->brand['alias'])); ?>"><?php echo $item['full_name']; ?></a><br>
            ...
            <div class="span4 auto">
                <div class="row">
                    ...
                    <div class="span2">
                        <div class="valign-text">
                            <p>
                                <a href="<?php echo $this->createUrl('/consumable/engines', array('model_id'=>$item->id, 'brand'=>$this->brand['alias'])); ?>"><?php echo $item->fullName; ?></a><br>
