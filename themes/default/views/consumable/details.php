<?php
    $this->breadcrumbs = array(
        'Каталог расходных материалов'=>array('consumable/index', 'brand'=>$this->brand['alias']),
    );
    if ( $autoModel )
        $this->breadcrumbs[$autoModel->name] = array('/consumable/engines', 'model_id'=>$autoModel->id, 'brand'=>$this->brand['alias']);
    if ( $engineModel )
...
<div class="catalog-container">
    ...
    <div id="top-grid" class="container page-title">
        <h2 class="georgia">Каталог расходных материалов</h2>
        <div>
