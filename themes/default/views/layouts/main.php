        ...
        <footer>
            <div class="footer-menu">
                ...
                <div class="best-company">
                    <a href="http://amobile-studio.ru/" target="_blank"><img src="<?php echo $this->getassetsurl(); ?>/img/amobile.png" alt=""></a> и Абарис друзья с 2013 года
                </div>
            </div>
            <div class="footer-logo">
                <a href="#inline-modal" class="fancybox"><img src="<?php echo $this->getassetsurl(); ?>/img/logo_footer.png"></a>
