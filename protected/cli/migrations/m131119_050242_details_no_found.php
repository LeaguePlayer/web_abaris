<?php
/**
 * Миграция m131119_050242_details_no_found
 *
 * @property string $prefix
 */
 
class m131119_050242_details_no_found extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{details_no_found}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{details_no_found}}', array(
            'id' => 'pk', // auto increment
			'article' => "varchar(40) COMMENT 'Артикул'",
			'username' => "varchar(100) COMMENT 'Пользователь'",
			'mail' => "varchar(100) COMMENT 'Email'",
			'date_find' => "datetime COMMENT 'Дата поиска'",
        ),
