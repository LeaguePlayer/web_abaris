<?php
/**
 * Миграция m131118_082310_depot_positions
 *
 * @property string $prefix
 */
 
class m131118_082310_depot_positions extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{depot_positions}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{depot_positions}}', array(
            'depot_id' => 'integer NOT NULL COMMENT "Склад"', // auto increment
			'position_id' => "integer NOT NULL COMMENT 'Товар'",
			'stock' => "integer DEFAULT 0 COMMENT 'Наличие'",
        ),
        'ENGINE=MyISAM DEFAULT CHARACTER SET = utf8 COLLATE = utf8_general_ci');

        $this->addPrimaryKey('depot_positions_pk', '{{depot_positions}}', 'depot_id, position_id');
    }
