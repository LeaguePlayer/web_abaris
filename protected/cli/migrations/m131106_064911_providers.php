<?php
/**
 * Миграция m131106_064911_providers
 *
 * @property string $prefix
 */
 
class m131106_064911_providers extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{providers}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{providers}}', array(
            'id' => 'pk', // auto increment
			'name' => "string COMMENT 'Поставщик'",
			'day_count' => "int COMMENT 'Время доставки до Тюмени (в днях)'",
        ),
