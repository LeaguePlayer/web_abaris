<?php
/**
 * Миграция m130916_114341_user_involces
 *
 * @property string $prefix
 */
 
class m130916_114341_user_involces extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{user_involces}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{user_involces}}', array(
            'id' => 'pk', // auto increment

			'invoice_number' => "VARCHAR(45) COMMENT 'Номер счета'",
			'date' => "DATETIME COMMENT 'Дама'",
			'cost' => "VARCHAR(45) COMMENT 'Стоимость'",
