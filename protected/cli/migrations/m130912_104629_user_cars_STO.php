<?php
/**
 * Миграция m130912_104629_user_cars_STO
 *
 * @property string $prefix
 */
 
class m130912_104629_user_cars_STO extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{user_cars_STO}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{user_cars_STO}}', array(
            'id' => 'pk', // auto increment

			'user_car_id' => "INT NOT NULL COMMENT 'ID автомобиля пользователя'",
			'maintenance_date' => "DATETIME COMMENT 'Дата прохождения ТО'",
			'maintenance_name' => "VARCHAR(45) COMMENT 'Название ТО'",
			'maintenance_type' => "TEXT COMMENT 'Вид работ'",
			'maintenance_cost' => "FLOAT COMMENT 'Сумма затрат'",
			'azs_cost' => "FLOAT COMMENT 'Затраты на АЗС'",
