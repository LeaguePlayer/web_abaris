<?php
/**
 * Миграция m130910_054201_bodytypes
 *
 * @property string $prefix
 */
 
class m130910_054201_bodytypes extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{bodytypes}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{bodytypes}}', array(
            'id' => 'pk', // auto increment
			'name' => "varchar(45) COMMENT 'Тип кузова'",
        ),
