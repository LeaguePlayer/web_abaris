<?php
/**
 * Миграция m131118_112440_provider_position
 *
 * @property string $prefix
 */
 
class m131118_112440_provider_position extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{provider_positions}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{provider_positions}}', array(
        ...
        $this->addPrimaryKey('provider_position_pk', '{{provider_positions}}', 'provider_id, position_id');
    }
