<?php
/**
 * Миграция m130912_054509_adaptabillity
 *
 * @property string $prefix
 */
 
class m130912_054509_adaptabillity extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{adaptabillity}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{adaptabillity}}', array(
            'id' => 'pk', // auto increment
			'detail_id' => "integer NOT NULL COMMENT 'Ссылка на деталь'",
            'auto_model_id' => "integer DEFAULT NULL COMMENT 'Модель автомобиля'",
            'engine_model_id' => "integer DEFAULT NULL COMMENT 'Модель двигателя'",
