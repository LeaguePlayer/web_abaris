<?php
/**
 * Миграция m131015_110557_messages
 *
 * @property string $prefix
 */
 
class m131015_110557_messages extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{messages}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{messages}}', array(
			...
			'from' => "varchar(150) COMMENT 'От кого'",
