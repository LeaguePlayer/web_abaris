<?php
/**
 * Миграция m130909_075303_brands
 *
 * @property string $prefix
 */
 
class m130909_075303_brands extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{brands}}', array(
            ...
            'alias' => "varchar(45) COMMENT 'Идентификатор'",
            'name' => "varchar(45) NOT NULL COMMENT 'Название'",
            'img_logo' => "varchar(256) COMMENT 'Логотип'",
